...
docker push qimia/llama-zmq-server-base-cuda-"$CUDA_VERSION":"$IMAGE_VERSION"
docker push qimia/llama-zmq-server-base-cuda-"$CUDA_VERSION":"$IMAGE_BRANCH"-latest
...
docker push qimia/llama-zmq-server-cuda-"$CUDA_VERSION":"$IMAGE_VERSION"
docker push qimia/llama-zmq-server-cuda-"$CUDA_VERSION":"$IMAGE_BRANCH"-latest
